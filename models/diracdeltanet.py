...
class DiracDeltaNet(nn.Module):
    def __init__(self, block, num_blocks, base_channelsize=48, num_classes=1000, weight_bit=4, act_bit=4, first_weight_bit=32, first_act_bit=32, last_weight_bit=32, last_act_bit=32, fc_bit=32, extern_init=False, init_model=nn.Sequential()):
        ...
        if not extern_init:
            self.conv1 = QuantConv_init(3, 12, kernel_size=1, stride=1, bias=False, bit=self.first_weight_bit)
            self.bn1 = nn.BatchNorm2d(12)
            self.quant_act1 = ActQuant_init_fixed(self.first_act_bit,6.0,fixed_rescale=6.0)
            self.shift1 = Shift3x3(12)
            self.conv2 = QuantConv_init(12, 48, kernel_size=1, stride=1, bias=False, bit=self.weight_bit)
            self.bn2 = nn.BatchNorm2d(48)
            self.quant_act2=ActQuant_init(self.act_bit,2.0)
            self.shift2 = Shift3x3(48)
            ...
            self.conv1 = QuantConv_init(3, 12, kernel_size=1, stride=1, bias=False, bit=self.first_weight_bit, extern_init=True, init_model=init_model.conv1)
            self.bn1 = init_model.bn1
            ...
            self.shift1 = Shift3x3(12)
            self.conv2 = QuantConv_init(12, 48, kernel_size=1, stride=1, bias=False, bit=self.weight_bit, extern_init=True, init_model=init_model.conv2)
